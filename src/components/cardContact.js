...
export default function Contact() {
  return (
    <footer className="flex items-center bg-yellow-100 gap-7 card-footer-logo">
      <img
        src={ logotipo }
      ...
      <div >
        <p 
          className="phrase-effect-mobile italic text-2xl font-bold text-neutral-900 border-b-2 border-yellow-400 p-2"
        >
